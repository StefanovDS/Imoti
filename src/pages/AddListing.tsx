    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-green-600 text-white py-2 px-4 shadow-md">
        <div className="max-w-7xl mx-auto flex space-x-6">
          <a href="#" className="hover:bg-green-700 px-3 py-1 rounded">Начало</a>
          <a href="#" className="hover:bg-green-700 px-3 py-1 rounded">Продажби</a>
          <a href="#" className="hover:bg-green-700 px-3 py-1 rounded">Наеми</a>
          <a href="#" className="hover:bg-green-700 px-3 py-1 rounded">Ново строителство</a>
        </div>
      </div>
